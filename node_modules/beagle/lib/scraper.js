...
Scraper.prototype = {
  ...
  getTitle: function(){
    ...
    // if (!title) {
    //   title = getTagValue($,  "meta", "name", "title", "content");
    //   if (!title)
    //     title = $('title').text();
    // }
    ...
    function addImg(image){
     ...
     if (!addImg(getTagValue($, "meta", "property", "og:image", "content"))) {
       ...
       if (!addImg(getTagValue($, "link", "rel", "image_src", "href"))) {
        ...
        // imagesFound = addImg(getTagValue($, "link", "rel", "image_src", "href"));
        // for(var i=0; i < imagesFound.length && images.length < 10; i++){
        //   addImg(imagesFound.eq(i).attr('src'));
        // }


        // imagesFound = addImg(getTagValue($, "link", "rel", "shortcut", "href"));
        // for(var i=0; i < imagesFound.length && images.length < 10; i++){
        //   addImg(imagesFound.eq(i).attr('src'));
        // }
